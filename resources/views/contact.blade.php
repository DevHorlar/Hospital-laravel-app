...
<body>
    ...
    <div class="container">
      <div class="row cs_gap_y_30">
        ...
        <div class="col-lg-6">
          ...
          <form class="cs_contact_form row cs_gap_y_30" action="./config/contact.php" method="post">
            <div class="col-md-6">
  ...
  <!-- End Location Map -->
  <!-- Start Footer -->
  <footer class="cs_footer cs_blue_bg cs_bg_filed cs_white_color mt-0" data-src="assets/img/footer_bg.jpg">
    <div class="container">
      <div class="cs_footer_row">
        <div class="cs_footer_col">
          <div class="cs_footer_highlight_col cs_accent_bg mt-0">
